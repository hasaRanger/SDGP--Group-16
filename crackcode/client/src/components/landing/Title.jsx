  ...
  return (
    <div className='relative '>
        ...
        <section id="title-section" className='w-full flex flex-col items-center justify-center mt-20 md:mt-60 '>
            <div className='text-center space-y-6 px-4 md:px-0 bg-black/10 py-10 rounded-xl'>
                ...
                <p className="text-xl md:text-xl text-[#ffffffde] text-balance max-w-3xl mx-auto leading-relaxed">
                Join the detective force and solve real-world coding challenges wrapped in thrilling mystery narratives. 
                Every case brings you close to <span className='text-transparent font-bold bg-clip-text bg-linear-to-r from-orange-400 to-orange-600'>mastery.</span>
                </p>

                <div className='flex justify-center gap-10 pt-10 bg-black/20 rounded-xl'>
                    <Button variant="primary" size="xl" icon={ChevronRight} iconPosition="right" onClick={() => navigate('/login')}>
                        Get Started
                    </Button>

                    <Button variant="outline" size="xl" onClick={() => navigate('/home')} className='text-orange-500'>
                        Learn More
                    </Button>
                </div>
            </div>
        ...
        <section id='features-section' className='w-full flex flex-col items-center justify-center py-12 px-4'>
            <div className='flex flex-row items-center justify-center gap-10 flex-wrap max-w-7xl'>
                ...
                that makes learning fun." icon={<BookOpenText className="w-8 h-8 text-orange-500" />} variant='flat' hoverEffect='slide' className='w-xs rounded-xl' padding='lg' /> 

                <Card title='Track Progress' description="Climb the leaderboard and earn xp, badges as you solve cases
                and master algorithms." icon={<ChartLine className="w-8 h-8 text-orange-500" />} variant='flat' hoverEffect='slide' className='w-xs rounded-xl' padding='lg' /> 

                <Card title='Career Growth' description="Build real skill that matter. Our career path guide you
                from beginner to expert." icon={<Rocket className="w-8 h-8 text-orange-500" />} variant='flat' hoverEffect='slide' className='w-xs rounded-xl' padding='lg' /> 
            </div>
        </section>
